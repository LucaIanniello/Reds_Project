...
class DISCRewardModel:
    ...
    def compute_reward(self, seq: List[Dict[str, Any]]):
        ...
        for i, rew in enumerate(rewards):
            ...
            seq[idx][DISCRewardModel.PRIVATE_LIKELIHOOD_KEY] = rew
        ...
        if seq[0]["is_first"]:
            ...
            for i, rew in enumerate(first_rewards):
                ...
                seq[i][DISCRewardModel.PRIVATE_LIKELIHOOD_KEY] = rew
        return seq

    def is_step_processed(self, step):
        return DISCRewardModel.PRIVATE_LIKELIHOOD_KEY in step.keys()
    ...
    def process_seq(self, seq):
        for step in seq:
            if not self.is_step_processed(step):
                continue
            step[DISCRewardModel.PUBLIC_LIKELIHOOD_KEY] = step[DISCRewardModel.PRIVATE_LIKELIHOOD_KEY]
